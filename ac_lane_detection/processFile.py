...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        img_test[:180*1,:640*1,0:3]=img_resized
        img_test[:180*1,640*1:640*2,0:3]=img_blurred
        
        img_test[180*1:180*2,:640*1,0]=img_hls
        img_test[180*1:180*2,:640*1,1]=img_hls
        img_test[180*1:180*2,:640*1,2]=img_hls
        ...
        '''
        img_test[180*1:180*2,:640*1,:]=cv2.cvtColor(threshold(rgb2hls(img_blurred)[:,:,0],thresh_hls)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*2:180*3,:640*1,:]=cv2.cvtColor(threshold(rgb2hls(img_blurred)[:,:,1],thresh_hls)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*3:180*4,:640*1,:]=cv2.cvtColor(threshold(rgb2hls(img_blurred)[:,:,2],thresh_hls)*255,cv2.COLOR_GRAY2RGB)

        img_test[180*1:180*2,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,0],thresh_lab)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*2:180*3,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,1],thresh_lab)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*3:180*4,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,2],thresh_lab)*255,cv2.COLOR_GRAY2RGB)
        ...
        #img_test[:180*1,640*2:640*3,:] = cv2.cvtColor(line_wr_bin(img_blurred)*255, cv2.COLOR_GRAY2RGB)
        #img_test[180*1:180*2,:640*1,:]=cv2.cvtColor(threshold(rgb2hls(img_blurred)[:,:,2],thresh_hls)*255,cv2.COLOR_GRAY2RGB)
        #img_test[180*1:180*2,640:640*2,:]=cv2.cvtColor((1-threshold(rgb2lab(img_blurred)[:,:,2],thresh_lab))*255,cv2.COLOR_GRAY2RGB)
        #img_test[180*1:180*2,640*2:640*3,:]=cv2.cvtColor((threshold(rgb2luv(img_blurred)[:,:,1],thresh_luv))*q255,cv2.COLOR_GRAY2RGB)
        #img_test[180*2:180*3,:640*1,:]=cv2.cvtColor(threshold(rgb2gray(img_blurred),thresh)*255,cv2.COLOR_GRAY2RGB)
        #img_test[180*2:180*3,640:640*2,:]=cv2.cvtColor(threshold(img_blurred[:,:,0],thresh)*255,cv2.COLOR_GRAY2RGB)
        #img_test[180*2:180*3,640*2:640*3,:]=cv2.cvtColor((1-threshold(rgb2luv(img_blurred)[:,:,1],thresh_luv))*255,cv2.COLOR_GRAY2RGB)

        img_test[:180*1,640*2:640*3,:] = cv2.cvtColor(combined_color(img_blurred)*255, cv2.COLOR_GRAY2RGB)
