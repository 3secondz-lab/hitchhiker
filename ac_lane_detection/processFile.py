...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        img_blurred = cv2.GaussianBlur(img_resized,(kernel,kernel),31)
        ...
        img_test[:180,640:640*2,0:3]=img_blurred
        
        img_test[180:180*2,:640,0]=img_hls
        img_test[180:180*2,:640,1]=img_hls
        img_test[180:180*2,:640,2]=img_hls
        img_test[180:180*2,640:640*2,0]=img_lab
        img_test[180:180*2,640:640*2,1]=img_lab
        img_test[180:180*2,640:640*2,2]=img_lab
        '''
        ...
        img_test[180:180*2,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,0],thresh)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*2:180*3,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,1],thresh)*255,cv2.COLOR_GRAY2RGB)
        img_test[180*3:180*4,640:640*2,:]=cv2.cvtColor(threshold(rgb2lab(img_blurred)[:,:,2],thresh)*255,cv2.COLOR_GRAY2RGB)
